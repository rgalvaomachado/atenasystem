...
<head>
	...
	<link rel="icon" href="../img/hubis-icon.png">	<link rel="icon" href="../img/hubis-icon.png">
</head>
<body style="background-color:white">
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main" style="background-color:white">
		<div class="row">
			<center>
				<img src='img/atena.jpeg' style="width:500px">
			</center>
		</div><!--/.row-->
