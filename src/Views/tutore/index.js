        ...
        complete: function(response) {
            ...
            if(response.access){
                ...
                setTimeout(function(){
                    alert.innerHTML = "";
                    $(function(){
                        $("#content").load("src/Views/tutore/criar.html");
                    });
                }, 1000);
            }else{
        ...
        complete: function(response) {
            ...
            if(response.access){
                ...
                setTimeout(function(){
                    alert.innerHTML = "";
                    $(function(){
                        $("#content").load("src/Views/tutore/editar.html");
                    });
                }, 1000);
            }else{
                alert.style.color = "red";
        ...
        complete: function(response) {
            ...
            if (response.access) {
                ...
                setTimeout(function(){
                    alert.innerHTML = "";
                    $(function(){
                        $("#content").load("src/Views/tutore/presenca.html");
                    });
                }, 2000);
            } else {
                alert.style.color = "red";
        ...
        complete: function(response) {
            ...
            if (response.access) {
                ...
                setTimeout(function(){
                    alert.innerHTML = "";
                    $(function(){
                        $("#content").load("src/Views/tutore/justificar.html");
                    });
                }, 2000);
            } else {
                alert.style.color = "red";
