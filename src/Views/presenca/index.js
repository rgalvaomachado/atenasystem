        ...
        complete: function(response) {
            ...
            if (response.access) {
                ...
                setTimeout(function(){
                    alert.innerHTML = "";
                    $(function(){
                        $("#content").load("src/Views/presenca/alune.html");
                    });
                }, 2000);
        ...
        complete: function(response) {
            ...
            if (response.access) {
                ...
                setTimeout(function(){
                    alert.innerHTML = "";
                    $(function(){
                        $("#content").load("src/Views/presenca/reuniao.html");
                    });
                }, 2000);
        ...
        complete: function(response) {
            ...
            if (response.access) {
                ...
                setTimeout(function(){
                    alert.innerHTML = "";
                    $(function(){
                        $("#content").load("src/Views/presenca/monitore.html");
                    });
                }, 2000);
            } else {
                alert.style.color = "red";
        ...
        complete: function(response) {
            ...
            if (response.access) {
                ...
                setTimeout(function(){
                    alert.innerHTML = "";
                    $(function(){
                        $("#content").load("src/Views/presenca/tutore.html");
                    });
                }, 2000);
            } else {
                alert.style.color = "red";
